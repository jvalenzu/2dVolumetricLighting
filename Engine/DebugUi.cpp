...
static const char* DebugUi::GetClipboardText()
{
    return glfwGetClipboardString(g_Window);
}

static void DebugUi::SetClipboardText(const char* text)
{
...
bool DebugUi::CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
void    DebugUi::InvalidateDeviceObjects()
{
...
bool DebugUi::Init(RenderContext* renderContext, bool install_callbacks)
{
    GLFWwindow* window = renderContext->m_Window;
    ...
    io.SetClipboardTextFn = DebugUi::SetClipboardText;
    io.GetClipboardTextFn = DebugUi::GetClipboardText;
// #ifdef _WIN32
...
// #endif
    ...
    {
        glfwSetMouseButtonCallback(window, DebugUi::MouseButtonCallback);
        glfwSetScrollCallback(window, DebugUi::ScrollCallback);
        glfwSetKeyCallback(window, DebugUi::KeyCallback);
        glfwSetCharCallback(window, DebugUi::CharCallback);
    }
...
{
    DebugUi::InvalidateDeviceObjects();
    ImGui::Shutdown();
}
